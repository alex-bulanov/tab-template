...
// Generate svg Sprite
function svgSprite() {
  return src('app/images/src/svg-icons/*.svg')
    .pipe(svgsprite({
      mode: {
        inline: true,
        stack: true
...
function startwatch() {
  ...
  watch('app/images/src/svg-icons/**/*.svg', { usePolling: true }, svgSprite)
...
exports.build = series(cleandist, scripts, styles, svgSprite, images, buildcopy, buildhtml)
exports.default = series(scripts, styles, svgSprite, images, parallel(browsersync, startwatch))
